...
export default function Overlay() {
  ...
  return (
    <div className="container">
      ...
      <AnimatePresence>{snap.intro ? <Intro key="main" config={config} /> : <Customizer key="custom" config={config} />}</AnimatePresence>
    </div>
  )
}
    ...
    <motion.section {...config}>
      <div className="section--container">
        ...
        <div className="support--content">
          <div>
            <p>
              Create your unique and exclusive shirt with our brand-new 3D customization tool. <strong>Unleash your imagination</strong> and
